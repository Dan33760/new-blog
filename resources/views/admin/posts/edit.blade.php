                    ...
                    <form method="POST" action="{{ route('post-update', $article->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <select id="category"
                                ...
                                <option value="{{ $item->id }}" @selected($article->id_category == $item->id)>{{ $item->nom }}</option>
                                @endforeach
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="contenu" rows="4"
                                ...
                                placeholder="Write your thoughts here...">{{ $article->contenu }}</textarea>
                            @error('contenu')
                            {{ $message }}
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            @if ($article->image)
                                <img src="{{ Storage::url($article->image) }}" width="50px" height="50px" alt="">
                            @endif
